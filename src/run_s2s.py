...
class DataTrainingArguments:
    ...
    add_method: Optional[str] = field(
        default="raw", metadata={"help": "A prefix to add before every source text (useful for T5 models)."}
    )
...
def main():
    ...
    data_collator = DataCollatorForNI(
        ...
        add_method=data_args.add_method
    )
    ...
    def compute_ni_metrics(dataset, preds, save_prefix=None):
        ...
        categories = ["aaa" for it in dataset["Categories"]]
